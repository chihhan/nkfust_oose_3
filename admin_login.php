...
<body>
  <div id="main">
	...
	<div id="site_content">        
		<div id="apDiv1">
          <center> 
          <p />
        	<form id="form" method="post" action="login_a.php"> 
  			<table align="center">
    		  <tr>
      		   <td align="center"><h2>管理員登入</h2></td>
    		  </tr>
    		  <tr>
     		   <td>
                 <table align="center">
 ...
 <!--close footer_container_box1-->      
	  ...
	  <br />
<center>
website template by 第九組 2014.12 
</center>

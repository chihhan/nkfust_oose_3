...
<body>
  ...
  <table border="1" cellpadding="2">
    <tr>
      <td width="133">留言筆數</td>
      <td width="140">姓名</td>
      <td width="132">留言內容</td>
      <td width="114">留言時間</td>
      <td width="51">刪除</td>
    </tr>
    <?php do { ?>
      <tr>
        ...
        <td><a href="msg_del.php?msgNo=<?php echo $row_Recordset1['msgNo']; ?>">刪除</a></td>
      </tr>
